...
class AbsorbersPlugin_AbsorbersPlugin {
  ...
  loadOptions(options, source) {
    ...
    if (optionsCast.absorbers === undefined) {
      optionsCast.absorbers = new Absorber_Absorber();
    }
    ...
    if (interactivityAbsorbers) {
      if (interactivityAbsorbers instanceof Array) {
        ...
        if (optionsCast.interactivity.modes.absorbers instanceof Array || optionsCast.interactivity.modes.absorbers === undefined) {
          optionsCast.interactivity.modes.absorbers = new Absorber_Absorber();
        }
...
class EmittersPlugin_EmittersPlugin {
  ...
  loadOptions(options, source) {
    ...
    if (optionsCast.emitters === undefined) {
      optionsCast.emitters = new Emitter_Emitter();
    }
    ...
    if (interactivityEmitters) {
      if (interactivityEmitters instanceof Array) {
        ...
        if (optionsCast.interactivity.modes.emitters instanceof Array || optionsCast.interactivity.modes.emitters === undefined) {
          optionsCast.interactivity.modes.emitters = new Emitter_Emitter();
        }
...
class PolygonMaskPlugin_PolygonMaskPlugin {
  ...
  loadOptions(options, source) {
    ...
    if (optionsCast.polygon === undefined) {
      optionsCast.polygon = new PolygonMask_PolygonMask();
    }
